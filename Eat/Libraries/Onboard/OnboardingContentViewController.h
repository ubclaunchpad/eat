...
@property (nonatomic) CGFloat actionButtonBottomMargin;
@property (nonatomic) CGFloat actionButtonHorizontalMargin;
@property (nonatomic) CGFloat actionButtonCornerRadius;
