...
- (void)viewWillLayoutSubviews {
  ...
  self.actionButton.layer.cornerRadius = self.actionButtonCornerRadius;
  self.actionButton.frame = CGRectMake(0 + self.actionButtonHorizontalMargin, CGRectGetMaxY(self.view.frame) - kActionButtonHeight - self.actionButtonBottomMargin, viewWidth - 2 * self.actionButtonHorizontalMargin, kActionButtonHeight);
}
